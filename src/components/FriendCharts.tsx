...
export function FriendCharts({ friendId, expenses }: { friendId: string; expenses: Expense[] }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center gap-2">
        <Pills options={DATE_RANGE_OPTIONS} value={range} onChange={setRange} />
      ...
      {filtered.length === 0 ? (
        <Card className="flex flex-col items-center gap-2 p-8 text-center">
          ...
          <p className="text-sm text-[#8a8593]">Tente outro filtro de data.</p>
        </Card>
      ) : (
        <>
